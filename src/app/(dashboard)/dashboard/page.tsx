        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 flex flex-col items-center">
              ...
              <span className="text-sm text-gray-500 mt-2">Total Documents</span>
            </div>
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 flex flex-col items-center">
              <span className="text-3xl font-bold text-green-600">45</span>
              <span className="text-sm text-gray-500 mt-2">Total Users</span>
            </div>
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 flex flex-col items-center">
              <span className="text-3xl font-bold text-purple-600">18</span>
              <span className="text-sm text-gray-500 mt-2">This Month Documents</span>
            </div>
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 flex flex-col items-center">
              <span className="text-3xl font-bold text-orange-600">+12%</span>
              <span className="text-sm text-gray-500 mt-2">Gain % Documents</span>
            </div>
          </div>
